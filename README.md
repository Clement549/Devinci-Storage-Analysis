...
DSA est un service d’aide au ramassage des déchets sous la forme d’un système physique comportant un ensemble de capteurs fixé à différentes poubelles. 
